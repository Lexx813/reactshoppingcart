...
export function booksReducers(state = {
 books: [
  {
   _id: 1,
   title: 'this is the service',
   description:'this is a d test',
   price: 400.34
  }, {
   _id: 2,
   title: 'this is the service 2',
   description:'this is a d test2',
   price: 300.34
  }
 ]
}, action) {
 switch (action.type) {
  ...
  case "UPDATE_BOOK":
   ...
   // object and concatenate witht he rest of items in the array
   return {
    books: [
